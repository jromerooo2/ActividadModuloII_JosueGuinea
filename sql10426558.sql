...
INSERT INTO `tbalumnos` (`idAlumno`, `nombreAlumno`, `apellidoAlumno`, `idSeccion`, `idEstado`, `direccion`, `idEspecialidad`, `Nota`) VALUES
(22, 'José', 'Merino', 2, 4, 'en el puente con david', 4, NULL),
(23, 'José', 'Herrera', 1, 1, 'en el puente con david', 1, NULL),
(29, 'Santiago', 'Merino', 3, 4, 'no se we en mi casa junto a mi peluche', 6, NULL);
...
INSERT INTO `tbmaestros` (`idMaestro`, `nombreMaestro`, `apellidoMaestro`, `idMateria`) VALUES
(9, 'Juan', 'Ramos', 1),
(10, 'Maria', 'Romero', 4),
(23, 'Jose Santiago', 'Merino Herrera', 1),
(24, 'Jose Antonio', 'Merino Flores', 3);
